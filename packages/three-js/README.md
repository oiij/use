...
Use ThreeJs 是基于 Three.js 的 Vue 3 封装，提供便捷的 3D 图形渲染功能，帮助开发者在应用中创建炫酷的 3D 场景和动画效果。
...
```vue
<script setup>
import { UseThree } from '@oiij/three-js'
</script>
...
- GitHub: [https://github.com/Eiog/@oiij/three-js](https://github.com/Eiog/@oiij/three-js) 🌟
