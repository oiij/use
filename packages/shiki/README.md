...
Use Shiki 是基于 Shiki 的 Vue 3 封装，提供便捷的代码高亮功能，帮助开发者在应用中实现精美的代码语法高亮效果。
...
<template>
  <UseShiki code="console.log('Hello World')" lang="ts" />
</template>
```
...
- GitHub: [https://github.com/Eiog/@oiij/shiki](https://github.com/Eiog/@oiij/shiki) 🌟
